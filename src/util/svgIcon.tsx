...
const SvgIcon = (key?: string) => {
    return (
        <a href="https://twitter.com/ngmtine" target="_blank">
            <svg style={{ display: "inline-block" }} xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" viewBox="0 0 60 60" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                <path
